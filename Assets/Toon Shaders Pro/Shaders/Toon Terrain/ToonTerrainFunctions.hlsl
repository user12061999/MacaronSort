#ifndef TOON_TERRAIN_FUNCTIONS_INCLUDED
#define TOON_TERRAIN_FUNCTIONS_INCLUDED
...
void ToonBakedGIData(Varyings input, inout InputData inputData)
{
...
#endif // TOON_TERRAIN_FUNCTIONS_INCLUDED
